...
|---------|-----------|-----------|---------|
| 510101 | （要確認） | 大阪機材センター01 | 5101: 大阪機材センター |
| 510102 | （要確認） | 大阪機材センター02 | 5101: 大阪機材センター |
| 310101 | （要確認） | 東京機材センター01 | 3101: 東京機材センター |
| 310102 | （要確認） | 東京機材センター02 | 3101: 東京機材センター |
| 510601 | （要確認） | 名古屋機材センター01 | 5106: 名古屋機材センター |
| 510801 | （要確認） | 福岡機材センター01 | 5108: 福岡機材センター |

> ⚠️ パスワードは過去のチャットで設定したもの。不明な場合は管理画面のユーザー管理からリセット可能（または `scripts/seed-admin.mjs` で再作成）。
